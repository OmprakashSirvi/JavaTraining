package com.javacourse.assessment.ques4;
...
public class Player {
	...
	public static Map<String, Integer> calculateNationalityCount(List<Player> playerList) {
		...
		for (Player player : playerList) {
			if (playerMap.containsKey(player.getNationality())) {
				playerMap.put(player.getNationality(), playerMap.get(player.getNationality()) + 1);
			} else
				playerMap.put(player.getNationality(), 1);
		}
		return playerMap;
	}
}
